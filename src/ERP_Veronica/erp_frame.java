...
public class erp_frame extends JFrame {
    ...
    protected String [] adminFields={"員工編號", "員工密碼", "員工資料表", "出缺勤表", "員工考績表", 
            "薪資表", "產品資料表", "原料庫存資料表", "訂單資料表", "訂購項目資料表", "資產管理表", 
            "異常資料表", "客戶資料表", "廠商資料表", "進貨表", "應收帳款管理表", "帳號管理表", "公告管理表","備註"};
    protected String [] purchaseFields={"No.","進貨單號", "原料編號", "進貨日期", "進貨廠商編號", "數量", "單價", 
            "採購人員", "備註"};
    protected String [] payableFields={"應付帳款編號", "進貨廠商編號", "交易日期", "應付日期", "應付金額", "付款方式", "進貨單號", 
            "沖帳日期", "沖帳金額", "沖帳折讓金額", "結案Y/N","備註"};
    protected String [] assetFields={"資產編號", "資產名稱", "數量", "購入金額", "採購日期", "使用部門", 
            "折舊年限","備註"};
...
//       setExtendedState(JFrame.MAXIMIZED_BOTH); 
    ...
    private void init(){
        ...
        setTitle("公司名稱 : 休閒小棧  使用者代碼 : "+logId);
