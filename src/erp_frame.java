...
<<<<<<< HEAD
	...
	String[] expendFields = { "下單日期", "訂單編號", "原料編號", "廠商編號", "數量", "價格", "打單員工", "備註" };
	String path = null;
	...
	private void initComponents() {
		...
		treeNode2.add(treeNode3);
		treeNode1.add(treeNode2);
		treeNode2 = new javax.swing.tree.DefaultMutableTreeNode("報表系統");
		treeNode3 = new javax.swing.tree.DefaultMutableTreeNode("銷售報表");
		treeNode3 = new javax.swing.tree.DefaultMutableTreeNode("毛利報表");
		treeNode2.add(treeNode3);
		treeNode1.add(treeNode2);
	...
	private void setButtonVisible() {
		if (treeFolder.getSelectionPath().getLastPathComponent().toString().equals("毛利報表")) {
...
>>>>>>> origin/master
			...
			String outputFile = "D:/ERPOutputFile/毛利報表.xlsx";
